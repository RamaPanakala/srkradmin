...
<html class="fixed">
	<head>
		...
		<meta name="keywords" content="srkrecadmin" />
		<meta name="description" content="srkr srkrec-administration">
					...
					<div class="card-body">
						<form method="post" class="login100-form validate-form p-b-33 p-t-5">
							<div class="current-user text-center">
								<img src="../img/cse_logo.png" alt="srkrec Logo" class="rounded-circle user-image"  />
