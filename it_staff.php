                        ...
                        <section class="card">
                            <header class="card-header" style="display:flex; flex-direction:row;gap:100px;justify-content:space-between;">
                                <table>
                                    <tr>
                                        <td>
                                            <h2 class="card-title mt-2" style="text-transform:uppercase;">SRKREC IT ADMINISTRATION</h2>
                                        </td>
...
for ($i = 0; $i < count($result); $i++) {
    ...
    $photoPath = '../profiles/images/IT/' . $id . '.jpg'; // Construct the photo path using eid
